...
2. Run ssSeq software through either a graphic user interface (GUI) or command line. Jump to [Program Arguments](#Program-Arguments), [Working with the GUI](#Working-with-the-GUI), and/or [Working through Command Line](#Working-through-Command-Line).
