...
from ssSeqSupport import BuildOutputDirs
...
def main():
    ...
    # Add an argument group for setting the output location
    ...
    CLArgs.update({"datetime": datetime, "output": output_dir, "fastq_r": ""})

    # Build output directories
    BuildOutputDirs(CLArgs)
